        ...
        <div style={{ display: 'flex', gap: '5px' }}>
          <button
            ...
            style={{
              flex: 1,
              padding: '5px',
              backgroundColor: selectedRenderMode === 'shaded' ? 'rgba(74, 144, 226, 0.9)' : 'rgba(20, 28, 48, 0.9)',
              border: '1px solid rgba(74, 144, 226, 0.25)',
              borderRadius: '8px',
              color: 'white',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              flex: 1,
              padding: '5px',
              backgroundColor: selectedRenderMode === 'mesh' ? 'rgba(74, 144, 226, 0.9)' : 'rgba(20, 28, 48, 0.9)',
              border: '1px solid rgba(74, 144, 226, 0.25)',
              borderRadius: '8px',
              color: 'white',
              cursor: 'pointer',
